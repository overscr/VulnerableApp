...
-- Level 10: BCrypt (cost factor raised from 4 to 12 - see AuthenticationVulnerability#level10LowIterationHashing)
-- Bcrypt hash (cost 12) for the same password 'sunshine'
INSERT INTO auth_users VALUES (10, 'admin_lowcost', '$2a$12$R8MIRfUxL9pZgOdlj.LVlujEMTbK7x/ANcHH4Q22H.TnxIaXI2IY6', NULL, 'BCRYPT_LOW_ITERATION', 10, 'admin_lowcost@example.com', 'ADMIN');
